...
def verify_email(event, context):
    ...
    verification_link = f"https://kaushikcloud.me./v1/user/verify?token={token}"
    ...
    try:
        ...
        response = requests.post(
            ...
            data={
                "from": "Webapp function <cloudassignment@kaushikcloud.me>",
                "to": [user_email],
    ...
    # # Construct Verification Link
    # verification_link = f"http://kaushikcloud.me.:8080/v1/user/verify?token={token}"
